...
public class Guard extends Card {
    ...
    static int numberOfCardsInDeck = 5;
    static String cardText = "Name a non-guard card and choose a player. If that player has that card, he or she is out of the round.";
    static String cardName = "Guard";
