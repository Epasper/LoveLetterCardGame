...
public class Prince extends Card {
    ...
    static int cardNumber = 5;
    static int numberOfCardsInDeck = 2;
    static String cardText = "Choose a player (including yourself) to discard his or her hand and draw a new card.";
    static String cardName = "Prince";
